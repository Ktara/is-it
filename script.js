...
(function(){
              ...
              $menuList.each(function(){
               ...
               if (punctPosition[4] - 100  < scrolled && scrolled - 300  < punctPosition[5]) {
                 $(".active_punct").removeClass("active_punct");
                 $($menuLi[4]).addClass("active_punct");
               }
               if (punctPosition[5] - 300  < scrolled && scrolled - 200  < punctPosition[6]) {
                 $(".active_punct").removeClass("active_punct");
                 $($menuLi[5]).addClass("active_punct");
               }
               if (punctPosition[6] - 200  < scrolled && scrolled - 100  < punctPosition[7]) {
                 $(".active_punct").removeClass("active_punct");
